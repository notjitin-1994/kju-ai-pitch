...
Three pillars. Nehemiah re-engineers how your institution operates: admissions, faculty load, compliance — automated, auditable, running in the background while your people focus forward.
...
This isn't a feature list. It's a new operating model for a university that intends to lead.`,
  ...
  nehemiah_naming: {
    text: `Nehemiah was one of the most trusted administrators in the ancient world — a man the king of Persia trusted with his life. He arrived at a broken institution, conducted a silent night audit before anyone knew his plans, and rebuilt it — systematically, accountably, on time. He restored compliance, unified records, reorganised governance — all while everyone else focused forward. That's not a metaphor. That's the job description. We named your operations layer Nehemiah because that is exactly what it does — and because this institution, of all institutions, knows what it means to build something that lasts.`,
  },
  elijah_naming: {
    text: `Elijah is the spiritual patriarch of the Carmelite tradition — the prophet on Mount Carmel from whom your congregation draws its identity. His greatest act wasn't calling fire from heaven. It was what came after. Exhausted, restored, and sent back — more powerful than before. He passed his mantle to Elisha, who received a double portion of his spirit. That is what this pillar does for your faculty. Not a tool. A transfer. Your educators leave with something they did not walk in with. We named it Elijah because Kristu Jayanti, of all institutions, understands exactly what that name carries.`,
  },
  daniel_naming: {
    text: `Daniel was enrolled as a student in the most powerful institution of the ancient world. Trained alongside the empire's best minds — and assessed. He was found ten times sharper than all of them. He never surrendered what he was formed to be. Your institution's own words say it: faith in God is the beginning of true wisdom. Daniel lived that before anyone wrote it down. He is not just a name for your student platform. He is the graduate Kristu Jayanti has always been trying to produce. Now you have a system designed to deliver him.`,
  },
  outcomes: {
