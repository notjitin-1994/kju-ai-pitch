...
export const slidesData: Slide[] = [
  {
    ...
    content: (
      <div className="relative h-full flex flex-col justify-center">
        <div className="relative z-20 space-y-12 max-w-lg text-left">
          <motion.div 
          ...
          <div className="space-y-4">
            <h1 className="text-[120px] font-display font-bold text-white leading-[0.9] tracking-tighter text-left">
              The AI <br /><span className="italic font-serif text-[#A7DADB]">Transformation</span>
            </h1>
          </div>
          <p className="text-6xl text-[#b0c5c6] font-light max-w-md leading-relaxed text-left">
