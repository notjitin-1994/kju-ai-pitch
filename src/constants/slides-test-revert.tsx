...
export const slidesData: Slide[] = [
  {
    ...
    content: (
      <div className="relative h-full flex flex-col justify-center">
        <div className="relative z-20 space-y-12 max-w-5xl text-left">
          ...
          >
            <img src="/uni-logo.png" alt="KJC" className="h-24 w-auto" />
            ...
            <div className="flex flex-col">
              ...
              <span className="text-3xl tracking-[0.4em] font-display uppercase font-bold text-white">Partnership</span>
            </div>
          </m.div>
          <div className="space-y-4">
            <m.h1 
              ...
              className="text-[120px] font-display font-bold text-white leading-[0.9] tracking-tighter text-left"
            >
    ...
    notes: "Thank you for having me. Today, we aren't just talking about software. We are talking about the future of the University."
  },
  {
    id: 2,
      ...
      <div className="grid grid-cols-2 gap-24 h-full items-center">
        <div className="space-y-12 relative z-20">
          <div className="bg-[#142433]/60 backdrop-blur-2xl p-16 rounded-[60px] border border-white/10 shadow-2xl">
            <div className="flex items-center gap-6 mb-12">
               ...
               <h4 className="text-4xl font-display font-bold text-[#A7DADB] uppercase tracking-[0.4em]">Evaluation</h4>
            </div>
            <p className="text-6xl font-display font-medium leading-[1.2] text-white">
        ...
        <div className="relative h-full rounded-[80px] overflow-hidden border border-white/10 shadow-2xl group min-h-[500px]">
          ...
          <div className="absolute bottom-12 left-12 flex items-center gap-4 z-20">
             ...
             <span className="text-3xl font-mono text-[#A7DADB] uppercase tracking-[0.4em]">Campus Insight</span>
          </div>
        </div>
      </div>
    ),
              ...
              <div className="relative h-full w-full rounded-[60px] overflow-hidden border border-white/5 shadow-2xl">
                ...
                <div className="relative z-10 p-12 h-full flex flex-col justify-between text-left">
                  ...
                  <div className="space-y-6">
                    <h3 className="text-5xl font-display font-bold text-white uppercase tracking-tighter">{item.label}</h3>
                    <p className="text-5xl text-[#A7DADB] font-serif italic">{item.status}</p>
                  </div>
                </div>
              </div>
            }
            back={
              <div className="relative h-full w-full rounded-[60px] overflow-hidden border border-[#A7DADB]/30 bg-[#142433] shadow-2xl p-16 flex flex-col justify-center items-start text-left space-y-10">
                ...
                <div className="space-y-4 relative z-10">
                  <h3 className="text-6xl font-display font-bold text-white uppercase tracking-widest text-left">The Truth</h3>
                  <p className="text-6xl text-[#b0c5c6] font-light leading-relaxed">
                    {item.detail}
                  </p>
                </div>
                <div className="pt-8 text-[#A7DADB] font-mono text-xl uppercase tracking-[0.4em] relative z-10 drop-shadow-[0_0_8px_rgba(167,218,219,0.5)]">
                  Click to return
                </div>
              </div>
            }
        ...
        <div className="relative h-full flex flex-col justify-center text-left">
          <div className="bg-[#142433]/80 backdrop-blur-2xl p-16 rounded-[80px] border border-white/10 shadow-2xl relative overflow-hidden group text-left">
            ...
            <div className="relative z-10 space-y-12">
               <div className="space-y-4">
                 <h4 className="text-4xl font-display font-bold text-[#A7DADB] uppercase tracking-[0.4em]">Placement Impact</h4>
            ...
            {[
              ...
              <div key={i} className="flex gap-10 items-start group text-left">
                ...
                <div className="space-y-3 pt-1">
                  ...
                  <p className="text-4xl text-[#b0c5c6] font-light leading-relaxed max-w-lg">{item.desc}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="bg-[#142433]/80 backdrop-blur-2xl p-16 rounded-[80px] border border-white/10 shadow-2xl relative overflow-hidden group text-left">
            ...
            <div className="relative z-10 space-y-12 text-left">
               <div className="space-y-4 text-left">
                 <h4 className="text-4xl font-display font-bold text-orange-400 uppercase tracking-[0.4em]">Pedagogical Impact</h4>
  ...
  },
  {
      ...
      <div className="grid grid-cols-2 gap-24 h-full items-center">
        <div className="relative h-full flex flex-col justify-center text-left">
          <div className="bg-[#A7DADB]/40 backdrop-blur-2xl p-20 rounded-[100px] border border-white/10 shadow-2xl relative overflow-hidden group text-left">
            ...
            <div className="relative z-10 space-y-12">
               <div className="space-y-4 text-left">
                 <h4 className="text-4xl font-display font-bold text-[#A7DADB] uppercase tracking-[0.4em]">Strategic Roadmap</h4>
               ...
               <p className="text-6xl text-white font-medium italic font-serif leading-relaxed text-left">
                 the University has the choice to redefine the regional <span className="text-[#A7DADB] underline decoration-white decoration-8">standard.</span>
               </p>
            </div>
          </div>
        </div>
            ...
            {[
              ...
              <div key={i} className="flex gap-10 items-start group text-left">
                ...
                <div className="space-y-4 pt-4 text-left">
                  <h4 className={`text-6xl font-display font-bold text-white uppercase tracking-tighter`}>{item.title}</h4>
                  <p className="text-5xl text-[#b0c5c6] font-light leading-relaxed max-w-lg text-left">{item.desc}</p>
                </div>
              </div>
            ))}
          </div>
    ...
    notes: "And for the University as a brand? The risk is stagnation. If your curriculum lags behind the industry, you lose out on the top-tier enrollments to institutions that tell a better innovation story."
  },
  {
    id: 8,
    tag: "The Shift",
            ...
            <div className="relative z-20 h-full p-10 flex flex-col justify-between text-left">
              ...
              <div className="space-y-4">
                <div className="space-y-1">
                  <h3 className="text-6xl font-display font-bold text-white tracking-tight uppercase text-left">
                    {item.title}
                  </h3>
                  <div className="h-1 w-12 bg-[#A7DADB] group-hover:w-24 transition-all duration-700" />
                </div>
                <p className="text-3xl font-body font-light text-[#b0c5c6] leading-relaxed max-w-[240px]">
                  {item.sub}
                </p>
              </div>
            </div>
    ...
    content: (
      <div className="grid grid-cols-12 gap-16 h-full items-center relative py-4 text-left">
        <div className="col-span-7 space-y-10 pr-8 text-left">
          <h2 className="text-7xl text-white font-display font-bold leading-[1] tracking-tighter text-left">
            Optimizing the <br />
            <span className="text-[#A7DADB] font-serif italic font-normal text-7xl">Institutional Footprint.</span>
          </h2>
          <div className="space-y-4 text-left">
            {[
              ...
              <div key={i} className="flex gap-8 items-center p-8 bg-[#142433] rounded-[32px] border border-white/10 hover:border-[#A7DADB]/40 transition-all duration-500 group text-left">
                ...
                <div className="space-y-1">
                  <h3 className="text-6xl font-bold text-white font-display tracking-tight uppercase leading-none text-left">{item.title}</h3>
                  <p className="text-4xl text-[#b0c5c6] font-body font-light text-left">{item.detail}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="col-span-5 h-[680px] relative group overflow-hidden rounded-[60px] border border-white/10 shadow-2xl">
          ...
          <div className="relative h-full flex flex-col items-center justify-center p-12 text-center">
            <div className="mb-4 inline-block px-5 py-1.5 rounded-full border border-[#A7DADB]/30 bg-[#A7DADB]/10 text-[#A7DADB] font-display text-2xl uppercase tracking-[0.3em]">
              Benchmark
            </div>
            <div className="text-[160px] font-display font-bold text-white leading-none tracking-tighter">
              70%
            </div>
            ...
            <div key={i} className="relative group h-[600px] rounded-[2.5rem] border-2 border-[#A7DADB]/30 bg-[#142433]/60 backdrop-blur-xl overflow-hidden transition-all duration-700 shadow-2xl">
              ...
              <div className="relative z-20 h-full p-10 flex flex-col gap-8 text-left">
                <div className="flex items-center gap-6 p-6 rounded-3xl bg-[#A7DADB] border border-[#A7DADB]/40 shadow-lg text-left">
                  ...
                  <h3 className="text-6xl font-display font-bold text-[#020C1B] uppercase tracking-tighter leading-none text-left">{item.title}</h3>
                </div>
                <p className="text-4xl text-[#b0c5c6] font-body font-light leading-relaxed px-2 text-left">{item.detail}</p>
              </div>
            </div>
          ))}
        </div>
    ...
    content: (
      <div className="grid grid-cols-12 gap-12 items-center h-full w-full text-left">
        <div className="col-span-7 space-y-12 text-left">
          <p className="text-6xl text-[#A7DADB] font-display italic font-light text-left leading-relaxed text-left">
            ...
            {[
              ...
              <div key={index} className="flex items-center gap-10 group transition-all duration-500 text-left">
                ...
                <div className="space-y-1 text-left">
                  <h4 className="text-6xl font-display font-bold text-white tracking-tight uppercase leading-none text-left">{item.title}</h4>
                  <p className="text-4xl text-[#b0c5c6] font-body font-light leading-relaxed text-left">{item.desc}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="relative p-12 rounded-[80px] bg-[#142433]/80 border border-white/10 backdrop-blur-3xl overflow-hidden group shadow-2xl h-[700px] flex flex-col items-center justify-center text-left">
            ...
            <div className="relative z-10 w-full flex flex-col items-center text-center">
              ...
              <div className="mt-12 text-center text-center">
                <span className="text-white font-serif italic text-5xl opacity-90 text-center">Cognitive Surge</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 gap-20 h-full items-center text-left">
          ...
          {[
            ...
            <div key={i} className="flex gap-10 items-start group text-left text-left">
              ...
              <div className="space-y-4 text-left">
                ...
                <p className="text-5xl text-[#b0c5c6] font-light leading-relaxed text-left text-left">{item.desc}</p>
              </div>
            </div>
          ))}
        </div>
        <div className="relative h-full min-h-[700px] bg-[#142433]/60 backdrop-blur-2xl rounded-[100px] overflow-hidden border border-[#A7DADB]/20 shadow-2xl group flex flex-col justify-center items-center text-center p-20 text-left">
           ...
           <div className="relative z-10 space-y-12 text-center">
             ...
             <h2 className="text-8xl font-display font-bold text-white leading-[0.85] tracking-tighter uppercase text-center">
                PRACTITIONER <br /><span className="italic font-serif text-[#A7DADB]">NOT</span> USER
             </h2>
             <p className="text-5xl text-[#b0c5c6] font-light italic px-12 text-center text-center">Equipping students with the intelligence to architect solutions.</p>
           </div>
        </div>
      </div>
    ),
              ...
              <div className="relative h-full p-16 flex flex-col justify-between text-left">
                ...
                <div className="space-y-10 w-full text-center">
                  ...
                  <div className="space-y-3 text-center text-center">
                    <h3 className="text-5xl font-display font-bold text-white uppercase tracking-[0.4em] text-center">{item.stream}</h3>
                  </div>
                </div>

                {/* Impact Statement (Subtitle) - Fixed to one line */}
                <div className="space-y-8 text-left text-left">
                  <h4 className="text-5xl font-serif italic text-[#A7DADB] leading-tight tracking-tight text-left uppercase opacity-90 whitespace-nowrap">
                    {item.impact}
                  </h4>
                  <p className="text-6xl text-[#b0c5c6] font-body font-light leading-relaxed opacity-60 group-hover:opacity-100 transition-opacity duration-700 text-left">
                    {item.detail}
                  </p>
                </div>
              </div>
        ...
        <div className="relative grid grid-cols-2 gap-20 w-full h-full items-center text-left text-left text-left">
          ...
          <div className="space-y-16 text-left">
            <div className="space-y-4 text-left">
              ...
              <p className="font-serif italic text-5xl text-[#b0c5c6]/30 text-left text-left">"The Legacy Approach"</p>
            </div>
          ...
          <div className="space-y-16 relative text-left pl-12 text-left text-left">
            <div className="space-y-4 text-left">
              ...
              <p className="font-serif italic text-5xl text-white/60 text-left text-left text-left">"Our Approach @ the University"</p>
            </div>
      ...
      <div className="relative h-full w-full flex flex-col justify-center overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col gap-0 w-full">
          ...
          <m.div 
            ...
            className="flex items-start gap-12 group self-start max-w-lg"
          >
            ...
            <div className="pt-0 space-y-3 flex-grow">
              <div className="flex items-center gap-6">
                <span className="font-mono text-3xl text-[#A7DADB] font-bold tracking-[0.5em] uppercase">Phase 1 // Weeks 1-3</span>
                <div className="h-px flex-grow bg-white/10" />
              </div>
              <div className="space-y-2">
                <h3 className="font-display text-7xl font-bold text-white tracking-tighter">Deep Discovery</h3>
                <p className="font-serif italic text-[#A7DADB] text-5xl">Mapping Institutional DNA</p>
              </div>
              <p className="font-body font-light text-[#b0c5c6] text-6xl leading-tight max-w-md border-l-2 border-[#A7DADB]/40 pl-8">
          ...
          <m.div 
            ...
            className="flex flex-row-reverse items-start gap-12 group self-end text-right max-w-lg"
          >
            <div className="relative shrink-0">
            ...
            <div className="pt-0 space-y-3 flex-grow flex flex-col items-end">
              <div className="flex items-center gap-4 flex-row-reverse w-full">
                <span className="font-mono text-3xl text-[#A7DADB] font-bold tracking-[0.5em] uppercase">Phase 2 // Weeks 4-11</span>
                <div className="h-px flex-grow bg-white/10" />
              </div>
              <div className="space-y-2">
                <h3 className="font-display text-7xl font-bold text-white tracking-tighter">The Vanguard</h3>
                <p className="font-serif italic text-[#A7DADB] text-5xl">Proof-of-Value Launch</p>
              </div>
  ...
  },
  {
      ...
      <div className="relative h-full w-full flex flex-col justify-center overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col gap-0 w-full">
          ...
          >
            ...
            <div className="pt-0 space-y-3 flex-grow">
              <div className="flex items-center gap-4">
                <span className="font-mono text-3xl text-[#A7DADB] font-bold tracking-[0.4em] uppercase">Phase 3 // Months 3-6</span>
                <div className="h-px flex-grow bg-white/10" />
              </div>
              <div className="space-y-1">
                <h3 className="font-display text-7xl font-bold text-white tracking-tighter">Full Scale</h3>
                <p className="font-serif italic text-[#A7DADB] text-5xl">Institutional Integration</p>
              </div>
              <p className="font-body font-light text-[#b0c5c6] text-6xl leading-tight max-w-md border-l-2 border-[#A7DADB]/40 pl-8">
          ...
          >
            ...
            <div className="pt-0 space-y-3 flex-grow flex flex-col items-end">
              <div className="flex items-center gap-4 flex-row-reverse w-full">
                <span className="font-mono text-3xl text-[#A7DADB] font-bold tracking-[0.4em] uppercase">Phase 4 // Continuous</span>
                <div className="h-px flex-grow bg-white/10" />
              </div>
              <div className="space-y-1">
              ...
              <p className="font-body font-light text-[#b0c5c6] text-6xl leading-tight max-w-md border-r-2 border-[#A7DADB]/40 pr-8 text-right">
                Solidifying the University as the definitive AI-native institution, leading the era of Indian higher education prestige.
              </p>
            </div>
          </m.div>
        </div>
    ...
    notes: "Scale is where the transformation becomes irreversible. Phase 3 expands our impact, and Phase 4 is where the University cements itself as the market leader in AI-driven education."
  },
  {
    id: 18,
    tag: "The Case",
        ...
        >
          ...
          <div className="relative z-20 p-16 h-full flex flex-col justify-between">
            <div className="space-y-6">
              ...
              <p className="text-4xl text-[#A7DADB] font-serif italic opacity-80">Direct Fiscal & Operational Impact</p>
            </div>
        ...
        >
          ...
          <div className="relative z-20 p-16 h-full flex flex-col justify-between">
            <div className="space-y-6">
              ...
              <p className="text-4xl text-[#A7DADB] font-serif italic opacity-80">Strategic Positioning & Legacy</p>
            </div>
        ...
        >
          ...
          >
            ...
            <div className="relative flex items-center justify-center gap-16 transition-all duration-1000 group-hover:scale-105">
              <img src="/uni-logo.png" alt="KJC" className="h-48 w-auto relative z-10 drop-shadow-[0_0_40px_rgba(167,218,219,0.4)]" />
        ...
        >
          <div className="flex gap-20">
            <div className="flex flex-col gap-1 text-left">
              ...
              <span className="text-[#A7DADB] font-mono text-2xl tracking-widest">[CRITICAL_PATH_SUCCESS]</span>
            </div>
            <div className="flex flex-col gap-1 text-left">
              <span className="text-[10px] text-[#b0c5c6]/40 uppercase tracking-[0.4em] font-display">Strategic deployment</span>
              <span className="text-white font-mono text-2xl tracking-widest">UNI_COGNITIVE_V1.0</span>
            </div>
          </div>
