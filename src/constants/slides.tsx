        ...
        <div className="relative grid grid-cols-2 gap-20 w-full h-full items-center text-left text-left text-left">
          ...
          <div className="space-y-16 relative text-left pl-12 text-left text-left">
            <div className="space-y-4 text-left">
              ...
              <p className="font-serif italic text-3xl text-white/60 text-left text-left text-left">"Our Approach @ the University"</p>
            </div>
        ...
        >
          <div className="flex gap-20">
            ...
            <div className="flex flex-col gap-1 text-left">
              ...
              <span className="text-white font-mono text-base tracking-widest">UNI_COGNITIVE_V1.0</span>
            </div>
          </div>
    ...
    content: (
      <div className="relative w-full h-full flex flex-col items-center justify-center text-center">
        ...
        <div className="absolute bottom-12 flex items-center gap-10 opacity-30">
          ...
          <span className="text-sm font-mono tracking-widest uppercase text-white/40">UNI_COGNITIVE_V1.0</span>
        </div>
      </div>
    ),
