    ...
    content: (
      <div className="h-full flex flex-col justify-center text-left">
        <div className="space-y-12 max-w-4xl">
          <p className="text-[52px] text-[#b0c5c6] font-body font-light leading-tight">
    ...
    content: (
      <div className="relative w-full h-full flex flex-col items-center justify-center px-12 text-center">
        <div className="relative z-10 w-full flex flex-col items-center">
          ...
          >
            <span className="text-4xl text-[#b0c5c6] font-display line-through decoration-[#4F46E5] decoration-8 opacity-60 uppercase tracking-[0.3em]">
