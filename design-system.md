...
## Typography
- **Display**: 'Quicksand', sans-serif (Bold/Medium)
- **Body**: 'Lato', sans-serif (Light/Regular)
- **Serif Accent**: 'Playfair Display' (Italic, for high-impact cinematic moments)
...
## Layout Principles
- **Container**: Fixed 1920x1080 canvas scaled dynamically to fit viewport.
- **Hierarchy**: Dramatic scale differences between headings and body text.
- **Breathability**: Generous padding (minimum 40px) and margin between sections.
